	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_EVAL_EXTENDEDHELP: [
				...
				'Так же вы можете использовать флаги --silent, --depth=число и --async для изменения поведения команды.',
				...
				'Флаг --async оборачивает код в асинхронную функцию, благодаря чему вы сможете использовать await, но вам так же придётся использовать return чтобы вернуть результат.',
			...
			COMMAND_INFO: [
				...
				'• ✅ "Finalizers", выполняющиеся после успешного выполнения команд (логирование, сбор статистики, очистка ответов)',
			...
			COMMAND_HELP_DM: '📥 | Список доступных вам команд отправлен вам в ЛС.',
			...
			COMMAND_ENABLE_DESCRIPTION: 'Активирует или временно активирует команду/ингибитор/монитор/финализатор. Состояние по-умолчанию буде восстановлено после перезагрузки.',
			COMMAND_DISABLE: (type, name) => `+ Успешно деактивировано ${type}: ${name}`,
			COMMAND_DISABLE_DESCRIPTION: 'Деактивирует или временно деактивирует команду/ингибитор/монитор/финализатор/событие. Состояние по-умолчанию буде восстановлено после перезагрузки.',
